...
const DepositForm = () => {
  const { initiateDeposit, depositLoading, supportedBanks, technicalErrors } = useWallet()
  ...
  const handleBankSelect = (selectedBankValue) => {
    ...
    let actualBankCode = ""
    if (typeof selectedBankValue === "object" && selectedBankValue !== null && selectedBankValue.code) {
      ...
      const foundBankByCode = supportedBanks.find((bank) => bank.code === selectedBankValue)
      const foundBankByName = supportedBanks.find((bank) => bank.name === selectedBankValue)
      ...
      if (foundBankByCode) {
        ...
        console.warn("Selected bank value not found in supported banks:", selectedBankValue)
  ...
  const handleSubmit = async (e) => {
    ...
    if (result.success) {
      setSuccess("Deposit initiated successfully! Please check your bank app to complete the transaction.")
  ...
  return (
    <div className="max-w-lg mx-auto">
      <div className="mb-6">
        <h3 className="text-lg font-medium text-gray-900 mb-2">Make a Deposit</h3>
        <p className="text-sm text-gray-600">Transfer money from your Ethiopian bank account to your trading wallet.</p>
      </div>
      {/* Success Message */}
      {success && (
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          {formData.amount && (
            <p className="mt-1 text-sm text-gray-500">Amount: ETB {formatCurrency(formData.amount)}</p>
          )}
        </div>
        ...
        <div>
          ...
          <p className="mt-1 text-xs text-gray-500">Enter the account number you want to transfer from</p>
        </div>
        {/* Submit Error */}
        {errors.submit && (
          ...
          <div className="ml-3">
            ...
            <div className="mt-2 text-sm text-blue-700">
              <ul className="list-disc pl-5 space-y-1">
                ...
                <li>You'll receive a notification in your bank app to confirm</li>
