        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-amber-200/50">
              <label htmlFor="amount" className="text-sm font-bold text-gray-900 mb-3 flex items-center">
            ...
            {/* Bank Account Field */}
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-amber-200/50">
              <label htmlFor="bankAccount" className="text-sm font-bold text-gray-900 mb-3 flex items-center">
          ...
          <div className="space-y-6">
            ...
            {/* Phone Number Field */}
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-amber-200/50">
              <label htmlFor="customerPhone" className="text-sm font-bold text-gray-900 mb-3 flex items-center">
